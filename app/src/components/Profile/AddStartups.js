...
const GSTNumber = ({ }) => {
  ...
  const gstVerification = () => {
    ...
    fetch(
      'http://localhost:8000/account/gstverify/',
      requestOptions,
    )
...
const CINNumber = ({ }) => {
  ...
  const sendCin = () => {
    ...
    fetch(
      'http://localhost:8000/account/cinverify/',
      requestOptions,
    )
      .then(response => response.text())
      .then(result => console.log(result))
...
const PanNumber = () => {
  ...
  const sendPan = () => {
    ...
    fetch(
      'http://localhost:8000/account/panverify/',
      requestOptions,
    )
      .then(response => response.text())
      .then(result => {
        ...
        fetch(
          'http://localhost:8000/account/startup/',
          requestOptions2,
        )
          .then(response => response.text())
          .then(result => {
...
const PatentNumber = ({ }) => {
  ...
  const sendPatent = async () => {
    ...
    fetch(
      'http://localhost:8000/account/patentverify/',
      requestOptions,
    )
      .then(response => response.text())
      .then(result => console.log(result))
...
const AddStartups = ({ navigation }) => {
  ...
  const sendData = async () => {
    ...
    fetch(
      'http://localhost:8000/account/entrepreneur/',
      requestOptions,
    )
      .then(response => response.text())
      .then(result => console.log(result))
