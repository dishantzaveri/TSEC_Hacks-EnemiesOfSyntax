  ...
  return (
    <div>
      ...
      <div className="flex flex-row justify-center">
        <div className="p-6 bg-white w-1/3 my-2 mx-32 rounded-lg shadow-md flex flex-col justify-center">
          ...
          <ul className="list-disc pl-5">
            {data.Education.map((school) => (
              <li key={school.id} className="my-4">
                ...
                <p className="text-gray-700">
                  Study field: {school.study_field}
                </p>
                <p className="text-gray-700">
                ...
                <p className="text-gray-700">
                  Extra Curriculars: {school.extracurriculars}
                </p>
                <p className="text-gray-700">
        ...
        <div className="p-6 w-1/3 my-2 mx-32 text-center bg-cyan-200 rounded-lg shadow-md flex flex-col justify-center">
          <h1 className="text-3xl font-medium">{data.User.name}</h1>
          <div className="my-4">
            <p className="text-gray-700">{data.User.email}</p>
          </div>
          ...
          <ul className="list-disc pl-5">
            {data.Education.map((school) => (
              <p key={school.id} className="my-4">
                <h3 className="text-lg font-medium">
                  Institute: {school.institute}
                </h3>
                <p className="text-gray-700">Degree: {school.degree}</p>
          ...
          <ul className="list-disc pl-5">
            {data.Experience.map((experience) => (
              <p key={experience.id} className="my-4">
                <h3 className="text-lg font-medium">
                  Title: {experience.job_title}
                </h3>
                <p className="text-gray-700">
      ...
      <button className="py-5 mx-48 px-10 bg-[#2eb6b8] text-white border-rounded-lg"> Download </button>
      <button className="py-5 mx-48 px-10 bg-[#2eb6b8] text-white border-rounded-lg"> Download </button>
      </div>
    </div>
  );
